...
export const ServicesPage: React.FC = () => {
  ...
  const [businessGroupPricing, setBusinessGroupPricing] = useState<BusinessGroupPricing[]>([
    {
      ...
      servicePrices: {
        '1': { commercialPrice: 1450.00, residentialPrice: 1250.00 },
        '2': { commercialPrice: 1150.00, residentialPrice: 950.00 },
        '3': { commercialPrice: 1350.00, residentialPrice: 1100.00 }
      },
    ...
    },
    {
      ...
      servicePrices: {
        '1': { commercialPrice: 1600.00, residentialPrice: 1400.00 },
        '2': { commercialPrice: 1300.00, residentialPrice: 1100.00 },
        '3': { commercialPrice: 1500.00, residentialPrice: 1300.00 }
      },
  ...
  const getServicePrice = (businessGroup: BusinessGroupPricing, serviceId: string): number => {
    ...
    return pricing ? (pricing.commercialPrice + pricing.residentialPrice) / 2 : 0;
  };
                              ...
                              <div>
                                ...
                                <div className="relative">
                                  ...
                                  <input
                                    ...
                                    step="0.01"
                                    min="0"
                                    value={getServicePricing(editingPricing, service.id).commercialPrice || service.commercialPrice || 0}
                              ...
                              <div>
                                ...
                                <div className="relative">
                                  ...
                                  <input
                                    ...
                                    step="0.01"
                                    min="0"
                                    value={getServicePricing(editingPricing, service.id).residentialPrice || service.residentialPrice || 0}
